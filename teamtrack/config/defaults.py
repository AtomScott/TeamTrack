...
# TeamTrack CONFIG
# #############################
_C.TRACKER.TEAMTRACK = CN()

# SportsLabKit tracker configuration
_C.TRACKER.TEAMTRACK.TRACKER_CFG = CN()
_C.TRACKER.TEAMTRACK.TRACKER_CFG.NAME = "SORT"
_C.TRACKER.TEAMTRACK.TRACKER_CFG.MAX_STALENESS = 30
_C.TRACKER.TEAMTRACK.TRACKER_CFG.MIN_LENGTH = 5

# SORTTracker specific configuration
_C.TRACKER.TEAMTRACK.TRACKER_CFG.MATCHING_FUNCTION = "IoUCMM"
_C.TRACKER.TEAMTRACK.TRACKER_CFG.GATE = 0.5

# ByteTracker specific configuration
_C.TRACKER.TEAMTRACK.TRACKER_CFG.MOTION_METRIC_GATE = 0.5
_C.TRACKER.TEAMTRACK.TRACKER_CFG.VISUAL_METRIC_GATE = 0.5
_C.TRACKER.TEAMTRACK.TRACKER_CFG.BETA = 0.5
_C.TRACKER.TEAMTRACK.TRACKER_CFG.SECOND_GATE = 0.9
_C.TRACKER.TEAMTRACK.TRACKER_CFG.DETECTION_SCORE_THRESHOLD = 0.6

# SportsLabKit detection model
_C.TRACKER.TEAMTRACK.DETECTION_MODEL = CN()
_C.TRACKER.TEAMTRACK.DETECTION_MODEL.MODEL_NAME = ""
_C.TRACKER.TEAMTRACK.DETECTION_MODEL.IMGSZ = 360
_C.TRACKER.TEAMTRACK.DETECTION_MODEL.MODEL = ""
_C.TRACKER.TEAMTRACK.DETECTION_MODEL.CONF = 0.5
_C.TRACKER.TEAMTRACK.DETECTION_MODEL.IOU = 0.25
_C.TRACKER.TEAMTRACK.DETECTION_MODEL.DEVICE = 0
_C.TRACKER.TEAMTRACK.DETECTION_MODEL.CLASSES = 0
_C.TRACKER.TEAMTRACK.DETECTION_MODEL.AUGMENT = False

# SportsLabKit motion model
_C.TRACKER.TEAMTRACK.MOTION_MODEL = CN()
_C.TRACKER.TEAMTRACK.MOTION_MODEL.MODEL_NAME = None

# Kalman Filter specific configuration
_C.TRACKER.TEAMTRACK.MOTION_MODEL.DT = 1 / 30
_C.TRACKER.TEAMTRACK.MOTION_MODEL.PROCESS_NOISE = 1e3
_C.TRACKER.TEAMTRACK.MOTION_MODEL.MEASUREMENT_NOISE = 1e-1
_C.TRACKER.TEAMTRACK.MOTION_MODEL.CONFIDENCE_SCALER = 1.0

# SportsLabKit image model
_C.TRACKER.TEAMTRACK.IMAGE_MODEL = CN()
_C.TRACKER.TEAMTRACK.IMAGE_MODEL.MODEL_NAME = None
_C.TRACKER.TEAMTRACK.IMAGE_MODEL.IMAGE_SIZE = (32, 32)
_C.TRACKER.TEAMTRACK.IMAGE_MODEL.DEVICE = 0
...
# TeamTrack HPO specific configuration
_C.HPO.VERBOSE = True
_C.HPO.RETURN_STUDY = False
_C.HPO.USE_BBDF = False
_C.HPO.REUSE_DETECTIONS = True
_C.HPO.SAMPLER = None
_C.HPO.PRUNER = None
