...
def main(args):
    ...
    for dataset_name in dataset_names:
        ...
        for subset in ["train", "test", "val"]:
            ...
            for csv_file in glob(os.path.join(subset_dir, "annotations", "*.csv")):
...
# python scripts/convert_teamtrack_to_mot.py --teamtrack-dir /Volumes/extra-storage/teamtrack/data/teamtrack --output-dir /Volumes/extra-storage/teamtrack/data/teamtrack-mot
